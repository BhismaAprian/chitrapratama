...
<div class="relative h-72 w-full bg-black flex justify-center align-items-center"
    ...
    <div class="text-center">
        <div class="text-2xl font-bold text-white mb-4">
            Product Knowladge - Report
        </div>
        <div class="text-gray-300 text-xs">
            Home / Product Knowladge / Report / {{ isset($_GET['keyword']) && $_GET['keyword'] != '' ? 'Search /
            '.$_GET['keyword'] :
            'Newest' }}
        </div>
    </div>
    <div class="w-10 h-10 flex absolute bottom-0">
        <a href="#report" class="m-auto">
...
{{-- Start Section Card --}}
<section id="report" class="mx-auto sm:px-32 px-4 sm:py-14 py-3">
    <div class="grid lg:grid-cols-3 grid-cols-2 mx-auto lg:gap-8 gap-4">
        ...
        <div
            ...
            <a href="{{ url('laporan/'.$laporan->slug) }}" class="relative overflow-hidden">
                <img class="rounded-t-lg" src="{{ asset('storage/'. $laporan->image) }}" alt="" />
            </a>
