...
<div class="relative h-72 w-full bg-black flex justify-center align-items-center"
    ...
    <div class="text-center">
        ...
        <div class="text-gray-300 text-xs">
            Home / Product Knowladge / Article / {{ isset($_GET['keyword']) && $_GET['keyword'] != '' ? 'Search /
            '.$_GET['keyword'] :
            'Newest' }}
        </div>
    </div>
    <div class="w-10 h-10 flex absolute bottom-0">
        <a href="#artikel" class="m-auto">
...
{{-- Start Section Card --}}
<section id="artikel" class="mx-auto sm:px-32 px-4 sm:py-14 py-3">
    <div class="grid lg:grid-cols-3 grid-cols-2 mx-auto lg:gap-8 gap-4">
        ...
        <div
            ...
            <a href="{{ url('artikel/'. $artikel->slug) }}" class="relative overflow-hidden">
                <img class="rounded-t-xl" src="{{ asset('storage/'. $artikel->image) }}" alt="" />
            </a>
